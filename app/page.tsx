    ...
    return (
      <main className="login-page">
        <section className="login-card">
          <div className="login-brand"><span>IC</span><div><b>대시보드</b><small>INTERSECTION CONTROL</small></div></div>
        ...
        <aside className="login-visual" aria-hidden="true"><div className="intersection-art"><div className="art-road road-north" /><div className="art-road road-east" /><div className="art-center"><i /><i /><i /><i /></div><div className="crosswalk crosswalk-n" /><div className="crosswalk crosswalk-e" /><div className="crosswalk crosswalk-s" /><div className="crosswalk crosswalk-w" /><span className="art-car car-a" /><span className="art-car car-b" /><span className="art-car car-c" /><div className="traffic-light"><i /><i /><i /></div></div><div className="visual-title"><small>INTERSECTION CONTROL</small><b>교차로를 한눈에,<br />기록은 빈틈없이.</b></div><div className="login-stat stat-a"><span>15분 집계</span><b>96</b><small>TIME SLOTS</small></div><div className="login-stat stat-b"><span>작업 흐름</span><b>03</b><small>PREP · COUNT · EXPORT</small></div></aside>
      </main>
    );
  }
